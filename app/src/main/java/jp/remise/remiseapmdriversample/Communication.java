...
class SendCommandThread extends Thread {
    ...
    private final int mEndCheckedBlockTimeout;
...
class SendCommandWithPresenterStateCheckThread extends Thread {
    private final Object mLock;
    private final Communication.SendCallback mSendCallback;
    private final Communication.PresenterStateCheckCallback mPresenterStateCallback;
    private final byte[] mCommands;
...
class SendCommandsMultiplePagesThread extends Thread {
    private final Object mLock;
    private StarIOPort mPort;
    private final List<byte[]> mCommandList;
    private final String mPortName;
    private final String mPortSettings;
    private final int mTimeout;
    private final int mEndCheckedBlockTimeout;
    private final int mHoldPrintTimeoutMillis;
    private final Context mContext;
    private final Communication.SendMultiplePagesCallback mCallback;
...
class SendCommandWithAutoInterfaceSelectThread extends Thread {
    private final Object mLock;
    private final Communication.AutoInterfaceSelectCallback mCallback;
    private final byte[] mCommands;
